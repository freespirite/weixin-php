...
CREATE TABLE IF NOT EXISTS `hy_ad` (
...
CREATE TABLE IF NOT EXISTS `hy_asset` (
...
CREATE TABLE IF NOT EXISTS `hy_auth_access` (
...
--
-- 转存表中的数据 `hy_auth_access`
--

INSERT INTO `hy_auth_access` (`role_id`, `rule_name`, `type`) VALUES
...
CREATE TABLE IF NOT EXISTS `hy_auth_rule` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='权限规则表' AUTO_INCREMENT=184 ;

--
-- 转存表中的数据 `hy_auth_rule`
--

INSERT INTO `hy_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
(174, 'Weixin', 'admin_url', 'weixin/index/default', NULL, '微信公众号', 1, ''),
(175, 'Weixin', 'admin_url', 'weixin/index/index', NULL, '公众号管理', 1, ''),
(176, 'Admin', 'admin_url', 'admin/weixinmsg/default', NULL, '消息管理', 1, ''),
(177, 'Weixin', 'admin_url', 'weixin/msg/index', NULL, '消息管理', 1, ''),
(178, 'Admin', 'admin_url', 'admin/weixinmsg/reply', NULL, '自动回复', 1, ''),
(179, 'Admin', 'admin_url', 'admin/weixinuser/default', NULL, '用户管理', 1, ''),
(180, 'Weixin', 'admin_url', 'weixin/user/index', NULL, '微信用户', 1, ''),
(181, 'Weixin', 'admin_url', 'weixin/reply/index', NULL, '自动回复管理', 1, ''),
(182, 'Weixin', 'admin_url', 'weixin/menu/index', NULL, '菜单管理', 1, ''),
(183, 'Weixin', 'admin_url', 'weixin/material/index', NULL, '图文管理', 1, '');
...
CREATE TABLE IF NOT EXISTS `hy_comments` (
...
--
-- 表的结构 `hy_common_action_log`
--

CREATE TABLE IF NOT EXISTS `hy_common_action_log` (
...
CREATE TABLE IF NOT EXISTS `hy_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hy_menu` (
  ...
  KEY `model` (`model`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='后台菜单表' AUTO_INCREMENT=196 ;

--
-- 转存表中的数据 `hy_menu`
--

INSERT INTO `hy_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
(187, 0, 'Weixin', 'Index', 'default', '', 0, 1, '微信公众号', 'weixin', '', 0),
(188, 187, 'Weixin', 'Index', 'index', '', 1, 1, '公众号管理', '', '', 0),
(189, 187, 'Weixin', 'Msg', 'index', '', 1, 1, '消息管理', '', '', 0),
(192, 187, 'Weixin', 'User', 'index', '', 1, 1, '微信用户', '', '', 0),
(193, 187, 'Weixin', 'Reply', 'index', '', 1, 1, '自动回复管理', '', '微信自动回复管理', 0),
(194, 187, 'Weixin', 'menu', 'index', '', 1, 1, '菜单管理', '', '', 0),
(195, 187, 'Weixin', 'material', 'index', '', 1, 1, '图文管理', '', '', 0);
...
CREATE TABLE IF NOT EXISTS `hy_nav` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='前台导航表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `hy_nav`
--

INSERT INTO `hy_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `hy_nav_cat` (
  `navcid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '导航分类名',
  `active` int(1) NOT NULL DEFAULT '1' COMMENT '是否为主菜单，1是，0不是',
  `remark` text COMMENT '备注',
  PRIMARY KEY (`navcid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='前台导航分类表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `hy_nav_cat`
--

INSERT INTO `hy_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `hy_oauth_user` (
...
CREATE TABLE IF NOT EXISTS `hy_options` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='全站配置表' AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `hy_options`
--

INSERT INTO `hy_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
CREATE TABLE IF NOT EXISTS `hy_plugins` (
...
INSERT INTO `hy_plugins` (`id`, `name`, `title`, `description`, `type`, `status`, `config`, `hooks`, `has_admin`, `author`, `version`, `createtime`, `listorder`) VALUES
(1, 'Mobileverify', '手机验证码', '手机验证码', 0, 1, '{"account_sid":"","auth_token":"","app_id":"","template_id":"","expire_minute":"30"}', 'send_mobile_verify_code', 1, 'ThinkCMF', '1.0', 0, 0);
...
CREATE TABLE IF NOT EXISTS `hy_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Portal文章表' AUTO_INCREMENT=1 ;
...
INSERT INTO `hy_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
(1, '超级管理员', 0, 1, '拥有网站最高管理员权限！', 1329633709, 1329633709, 0),
(2, 'viewer', NULL, 1, 'only to view', 1487146715, 1488423882, 0),
(3, '普通管理员', NULL, 1, '管理后台日常操作', 1487324931, 1488534045, 0);
...
CREATE TABLE IF NOT EXISTS `hy_route` (
...
CREATE TABLE IF NOT EXISTS `hy_slide` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='幻灯片表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `hy_slide_cat` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='幻灯片分类表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `hy_terms` (
  ...
  PRIMARY KEY (`term_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `hy_terms`
--

INSERT INTO `hy_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
--
-- 表的结构 `hy_term_relationships`
--

CREATE TABLE IF NOT EXISTS `hy_term_relationships` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类对应表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `hy_users` (
  ...
  `sid` mediumint(9) NOT NULL DEFAULT '0' COMMENT '网站id',
  PRIMARY KEY (`id`),
...
INSERT INTO `hy_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`, `sid`) VALUES
(1, 'admin', '###bde1ebb36f12482b5c1dc24fd89fc9ac', 'admin', 'admin@163.com', '', NULL, 0, '2000-01-01', NULL, '0.0.0.0', '2017-05-31 14:51:50', '2017-02-15 04:15:59', '', 1, 0, 1, 0, '', 1),
(3, 'user001_163_com', '###74a860712a4196f1f7b778337c0052dd', 'user001_163_com', 'user001@163.com', '', NULL, 0, '2000-01-01', NULL, '0.0.0.0', '2017-02-17 17:51:32', '2017-02-17 17:51:32', '', 1, 0, 2, 0, '', 1),
(4, 'admin01', '###961b84bea47f31f6899cd1ef780b3662', '', 'admin01@163.com', '', NULL, 0, '2000-01-01', NULL, '0.0.0.0', '2017-02-17 17:54:10', '2017-02-17 17:53:29', '', 0, 0, 1, 0, '', 1);

-- --------------------------------------------------------

--
-- 表的结构 `hy_user_favorites`
--

CREATE TABLE IF NOT EXISTS `hy_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hy_weixin_conf` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `account` varchar(50) NOT NULL DEFAULT '' COMMENT '微信号',
  `name` varchar(60) NOT NULL DEFAULT '' COMMENT '账号名称',
  `level` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1=订阅号，2=服务号',
  `key` varchar(50) NOT NULL DEFAULT '' COMMENT '账号AppId',
  `secret` varchar(50) NOT NULL DEFAULT '' COMMENT '账号AppSecret',
  `aeskey` varchar(50) NOT NULL DEFAULT '' COMMENT 'EncodingAESKey(消息加解密密钥)',
  `token` varchar(50) NOT NULL DEFAULT '' COMMENT '账号Token',
  `pic1` varchar(50) NOT NULL DEFAULT '' COMMENT '二维码图片地址',
  `pic2` varchar(50) NOT NULL DEFAULT '' COMMENT '用户头像',
  `remark` varchar(400) NOT NULL DEFAULT '' COMMENT '描述',
  `code` char(32) NOT NULL DEFAULT '' COMMENT '公众号标识位',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `sid` mediumint(9) NOT NULL DEFAULT '0' COMMENT '网站id',
  `pass` tinyint(1) NOT NULL DEFAULT '1' COMMENT '-1=配置错误，0=未通过认证，1=通过认证',
  PRIMARY KEY (`id`),
  KEY `code` (`code`),
  KEY `sid` (`sid`,`key`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='微信公众账号信息表';
...
CREATE TABLE IF NOT EXISTS `hy_weixin_menu` (
...
CREATE TABLE IF NOT EXISTS `hy_weixin_msg` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
  `wxid` int(10) unsigned NOT NULL DEFAULT '0',
  `to_user_name` varchar(32) NOT NULL DEFAULT '' COMMENT '开发者微信号',
  `from_user_name` varchar(32) NOT NULL DEFAULT '' COMMENT '发送方帐号（OpenID）',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '消息创建时间',
  `msg_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1=text,2=image,3=voice,4=video,5=shortvideo,6=location,7=link',
  `content` text NOT NULL COMMENT '文本消息内容',
  `msg_id` varchar(20) NOT NULL DEFAULT '' COMMENT '消息id',
  `sid` mediumint(9) NOT NULL DEFAULT '0' COMMENT '网站id',
  PRIMARY KEY (`id`),
  KEY `from_user_name` (`from_user_name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='微信用户发送信息表';

-- --------------------------------------------------------

--
-- 表的结构 `hy_weixin_replyset`
--

CREATE TABLE IF NOT EXISTS `hy_weixin_replyset` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `wxid` int(10) unsigned NOT NULL DEFAULT '0',
  `add_info` text NOT NULL COMMENT '新关注用户回复信息',
  `default_info` text NOT NULL COMMENT '默认回复信息',
  `keyword_info` text NOT NULL COMMENT '关键字回复信息',
  `addtime` int(10) DEFAULT '0' COMMENT '添加时间',
  `updatetime` int(10) DEFAULT '0' COMMENT '更新时间',
  `sid` mediumint(9) NOT NULL DEFAULT '0' COMMENT '网站id',
  PRIMARY KEY (`id`),
...
--
-- 表的结构 `hy_weixin_users`
--

CREATE TABLE IF NOT EXISTS `hy_weixin_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `wxid` int(10) unsigned NOT NULL DEFAULT '0',
  `nickname` varchar(50) NOT NULL DEFAULT '' COMMENT '微信昵称',
  `openid` char(32) NOT NULL DEFAULT '' COMMENT '微信id',
  `sex` tinyint(1) DEFAULT '0' COMMENT '男女，1男，2女, 0未知',
  `country` varchar(50) NOT NULL DEFAULT '',
  `province` varchar(60) NOT NULL DEFAULT '' COMMENT '省份',
  `city` varchar(15) NOT NULL DEFAULT '' COMMENT '城市',
  `headimgurl` varchar(250) NOT NULL DEFAULT '' COMMENT '头像路径',
  `subscribe_time` int(10) NOT NULL DEFAULT '0' COMMENT '关注时间',
  `remark` varchar(60) NOT NULL DEFAULT '' COMMENT '公众号运营者对粉丝的备注',
  `groupid` smallint(6) NOT NULL DEFAULT '0' COMMENT '用户所在的分组ID',
  `status` tinyint(1) DEFAULT '1' COMMENT '账号类型，1=正常，2=禁用',
  `addtime` int(10) DEFAULT '0' COMMENT '添加时间',
  `updatetime` int(10) DEFAULT '0' COMMENT '更新时间',
  `sid` mediumint(9) NOT NULL DEFAULT '0' COMMENT '网站id',
  PRIMARY KEY (`id`),
