...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Weixin'),
...
//        'DEFAULT_MODULE'        =>  'Portal',  // 默认模块
        ...
        'WEIXIN' => array(
            'SERVER_URL'     => 'http://xxx.xxx.com/wx.php?key=',
            'MSG_TYPE' => array(
                'text' => 1, 
                'image' => 2,
                'voice' => 3,
