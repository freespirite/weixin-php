<?php
require_once(APP_PATH . '/Common/Library/ucloud/conf.php');
require_once(APP_PATH . '/Common/Library/ucloud/http.php');
require_once(APP_PATH . '/Common/Library/ucloud/utils.php');
require_once(APP_PATH . '/Common/Library/ucloud/digest.php');
...
function UCloud_PutFile($bucket, $key, $file)
{
    ...
    //if(file_exists('../ucloud/http.php')) {echo 'found file http<br/>'.__FILE__.'<br/>'.$host;exit;} else {exit('not file found ');}
