                            ...
                            <div class="login-box-plain">
                                ...
                                <form role="form" method="post" onsubmit="return postlogin()">
                                  ...
                                  <div class="form-inline"> 
                                    ...
                                    <img src="<?php echo U('Admin/Index/imgcode');?>" id="imgcode" width="100" height="35">
                                  </div>
                            ...
                            <div class="login-box-plain">
                                ...
                                <form role="form" method="post" onsubmit="return postreg()">
                                  ...
                                  <div class="form-inline"> 
                                      ...
                                      <img src="<?php echo U('Admin/Index/imgcode');?>" id="rimgcode" width="100" height="35">
                                  </div>
                                  <div class="form-actions">
	...
	<script type="text/javascript">
        ...
        $(function(){
            $('#imgcode').click(function(){
                $(this).attr("src","<?php echo U('Admin/Index/imgcode');?>");
            });
        });
        function postlogin() {
            var pwd = $('#pwd').val();
            ...
            $.ajax({ 
                    ...
                    success: function (json) { 
                            ...
                            $('#code').val('');
                            $('#imgcode').attr("src","<?php echo U('Admin/Index/imgcode');?>");
        ...
        function postreg() {
            ...
            $.ajax({ 
                    type: "post", 
                    url: "<?php echo U('Admin/Index/register','','');?>",
                    ...
                    success: function (json) { 
                            ...
                            $('#rcode').val('');
                            $('#rimgcode').attr("src","<?php echo U('Admin/Index/imgcode');?>");
